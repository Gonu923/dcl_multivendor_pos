...
<body>
            ...
            <div class="col-md-10 col-8">
                <div class="owl-carousel owl-theme">
                    <div class="item ">
                        <div class="card border-0 " style="width: 70%; margin: auto;">
                            <img style="border-radius: 50%; width: 100px; height:100px"
                                src="./assets/img/category_slide_bar/cloth_store.png" alt=""
                    ...
                    <div class="item ">
                        <div class="card border-0 " style="width: 70%;margin: auto;">
                            <img style="border-radius: 50%; width: 100px; height:100px"
                                src="./assets/img/category_slide_bar/electronics.png" alt=""
                                class="card-img-top mx-auto">
                            <div class="card-body p-0">
                                <div class="card-title text-center">
                    ...
                    <div class="item ">
                        <div class="card border-0 " style="width: 70%;margin: auto;">
                            <img style="border-radius: 50%; width: 100px; height:100px"
                                src="./assets/img/category_slide_bar/food.png" alt=""
                                class="card-img-top mx-auto">
                            <div class="card-body p-0">
                                <div class="card-title text-center">
                    ...
                    <div class="item ">
                        <div class="card border-0 " style="width: 70%;margin: auto;">
                            <img style="border-radius: 50%; width: 100px; height:100px"
                                src="./assets/img/category_slide_bar/hardware-store.png" alt=""
                                class="card-img-top mx-auto">
                            <div class="card-body p-0">
                                <div class="card-title text-center">
                    ...
                    <div class="item ">
                        <div class="card border-0 " style="width: 70%;margin: auto;">
                            <img style="border-radius: 50%; width: 100px; height:100px"
                                src="./assets/img/category_slide_bar/medical-shop.png" alt=""
                                class="card-img-top mx-auto">
                            <div class="card-body p-0">
                                <div class="card-title text-center">
                    ...
                    <div class="item">
                        <div class="card border-0 " style="width: 70%;margin: auto;">
                            <img style="border-radius: 50%; width: 100px; height:100px"
                                src="./assets/img/category_slide_bar/mudi.png" alt=""
                                class="card-img-top mx-auto">
                            <div class="card-body p-0">
                                <div class="card-title text-center">
                                    <p class="text-dark mb-0">Mudir Dukhan</p>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-start" id="navbarSupportedContent"
                ...
                <ul class="navbar-nav mx-auto mb-2 mx-4 mb-lg-0 ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link txt_color " aria-current="page" href="{{ Url('services') }}">Our
                            Service</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link txt_color dropdown-toggle " href="#" id="navbarDropdown"
    ...
    <footer id="footer">
        ...
        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright by: <strong><span>Dhaka Choice Ltd</span></strong> {{ Date("Y") }}.
            </div>
            <div class="credits">
