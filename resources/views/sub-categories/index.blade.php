                            ...
                            <tbody>
                                @foreach ($subcats as $subcat)
                                    <tr>
                                        ...
                                        <td>{{ $subcat->name }}</td>
                                        <td><img src="{{ $subcat->getSubCategoryImage() }}"
                                                alt="{{ $subcat->getSubCategoryImage() }}"
                                                style="width: 50px; height: 30px;"></td>
                                        <td>
                                            <a href="{{ route('subcategories.edit', $subcat) }}" class="btn btn-primary"><i
                                                    class="fas fa-edit"></i></a>
                                            <button class="btn btn-danger btn-delete"
                                                data-url="{{ route('subcategories.destroy', $subcat) }}"><i
                    ...
                    <div class="card-body">
                        <form action="{{ route('subcategories.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="file" name="image" placeholder="Sub Category Image"
                                        class="form-control">
                                </div>
                            </div>
